      ...
      <div className="container middlebar-flex">
        <div className="middlebar-left">
          <div className="middlebar-social">
            ...
            {/* Google */}
            <a
              href="https://www.google.com/search?q=Mahirash+Perfumes"
              target="_blank"
              rel="noopener noreferrer"
              className="social-icon-btn"
              title="Google"
            >
              <svg className="w-6 h-6 text-black" viewBox="0 0 24 24" fill="currentColor">
                <path d="M21.35 11.1H12v2.98h5.36c-.23 1.48-1.68 4.35-5.36 4.35-3.23 0-5.86-2.67-5.86-5.96s2.63-5.96 5.86-5.96c1.84 0 3.07.78 3.78 1.45l2.58-2.49C16.92 3.94 14.7 3 12 3 6.92 3 2.8 7.13 2.8 12.2S6.92 21.4 12 21.4c6.02 0 9.2-4.23 9.2-8.08 0-.54-.06-.94-.13-1.32z" />
              </svg>
            </a>
          </div>
